...
{
    /* LVGL 8.1 passes one fully formatted string to the log callback.  Keeping
     * the exact callback type lets the compiler catch API mismatches instead
     * of turning warning messages into invalid pointer accesses. */
